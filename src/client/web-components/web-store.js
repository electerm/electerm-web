...
import initState from '../../external/store/init-state'
import loadDataExtend from '../../external/store/load-data'
import dbUpgradeExtend from '../../external/store/db-upgrade'
import eventExtend from '../../external/store/event'
import syncExtend from '../../external/store/sync'
import appUpgrdeExtend from '../../external/store/app-upgrade'
import bookmarkGroupExtend from '../../external/store/bookmark-group'
import bookmarkExtend from '../../external/store/bookmark'
import commonExtend from '../../external/store/common'
import contextMenuExtend from '../../external/store/context-menu'
import itemExtend from '../../external/store/item'
import quickCommandExtend from '../../external/store/quick-command'
import sessionExtend from '../../external/store/session'
import settingExtend from '../../external/store/setting'
import sidebarExtend from '../../external/store/sidebar'
import sysMenuExtend from '../../external/store/system-menu'
import tabExtend from '../../external/store/tab'
import uiThemeExtend from '../../external/store/ui-theme'
import terminalThemeExtend from '../../external/store/terminal-theme'
import transferHistoryExtend from '../../external/store/transfer-history'
import batchInputHistory from '../../external/store/batch-input-history'
import transferExtend from '../../external/store/transfer-list'
import addressBookmarkExtend from '../../external/store/address-bookmark'
...
import {
  ...
  sidebarPanelWidth,
  paneMap
} from '../../external/common/constants'
import getInitItem from '../../external/common/init-setting-item'
import {
  theme
} from 'antd'
