...
import loadDataExtend from '../../electerm-react/store/load-data'
import dbUpgradeExtend from '../../electerm-react/store/db-upgrade'
import eventExtend from '../../electerm-react/store/event'
import syncExtend from '../../electerm-react/store/sync'
import appUpgrdeExtend from '../../electerm-react/store/app-upgrade'
import bookmarkGroupExtend from '../../electerm-react/store/bookmark-group'
import bookmarkExtend from '../../electerm-react/store/bookmark'
import commonExtend from '../../electerm-react/store/common'
import contextMenuExtend from '../../electerm-react/store/context-menu'
import itemExtend from '../../electerm-react/store/item'
import quickCommandExtend from '../../electerm-react/store/quick-command'
import sessionExtend from '../../electerm-react/store/session'
import settingExtend from '../../electerm-react/store/setting'
import sidebarExtend from '../../electerm-react/store/sidebar'
import sysMenuExtend from '../../electerm-react/store/system-menu'
import tabExtend from '../../electerm-react/store/tab'
import uiThemeExtend from '../../electerm-react/store/ui-theme'
import terminalThemeExtend from '../../electerm-react/store/terminal-theme'
import transferHistoryExtend from '../../electerm-react/store/transfer-history'
import batchInputHistory from '../../electerm-react/store/batch-input-history'
import transferExtend from '../../electerm-react/store/transfer-list'
import addressBookmarkExtend from '../../electerm-react/store/address-bookmark'
...
import getInitItem from '../../electerm-react/common/init-setting-item'
import {
  theme
} from 'antd'
